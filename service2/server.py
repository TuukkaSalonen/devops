...
def status():
    ...
    try:
        with open("/proc/uptime") as file:
            ...
            uptime = "{:.2f}".format(uptime_seconds / 3600)
    ...
    statusRecord = f"{timestamp}: uptime {uptime} hours, free disk in root: {free_diskspace} MBytes"
    ...
    try:
        with open(vstorage_file, "a") as file:
            file.write(statusRecord + "\n")
    except Exception as e:
        print(f"Error writing to vstorage file: {e}")
